  ...
  datatables.forEach(datatable => {
    ...
    $("#CountryId").change(function (e) {
        ...
        const settings = {
            "async": true,
            "crossDomain": true,
            "url": "https://localhost:7155/Admin/getStates/",
            "method": "POST",
            "headers": {},
            "data": {
                "countryid": countryid
        ...
        $.ajax(settings).done(function (response) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                html += `<option value="${element.StateId}">${element.StateName}</option>`
            }
            $("#StateId").html(html);
    ...
    $("#StateId").change(function (e) {
        ...
        const settings = {
            "async": true,
            "crossDomain": true,
            "url": "https://localhost:7155/Admin/getCity/",
            "method": "POST",
            "headers": {},
            "data": {
                "stateid": stateid
        ...
        $.ajax(settings).done(function (response) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                html += `<option value="${element.CityId}">${element.CityName}</option>`
            }
            $("#CityId").html(html);
        });
    });
